            ...
            <View style={{ flex: 1 }}>
                <ScrollView style={styles.screen}>
                    <View style={styles.wrapper}>
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img6} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img7} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img8} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                                ...
                                <Text style={styles.textPrice}>2.000.000 VND</Text>
                                <Text style={styles.textMater}>Material: Cotton</Text>
                                <Text>Color: Black</Text>
                            </View>
                            <TouchableOpacity style={styles.iconstyle}>
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img9} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                                ...
                                <Text style={styles.textPrice}>1.300.000 VND</Text>
                                <Text style={styles.textMater}>Material: Cotton</Text>
                                <Text>Color: Black</Text>
                            </View>
                            <TouchableOpacity style={styles.iconstyle}>
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img10} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                                ...
                                <Text style={styles.textPrice}>1.500.000 VND</Text>
                                <Text style={styles.textMater}>Material: Cotton</Text>
                                <Text>Color: Black</Text>
                            </View>
                            <TouchableOpacity style={styles.iconstyle}>
                        ...
                        <View style={styles.productContainer}>
                            <Image source={Img11} style={styles.productImg} />
                            <View style={styles.productInfo}>
                                <TouchableOpacity
                                    onPress={() =>
                                        this.props.navigation.navigate('DetailProduct',
                                ...
                                <Text style={styles.textPrice}>1.800.000 VND</Text>
                                <Text style={styles.textMater}>Material: Cotton</Text>
                                <Text>Color: Black</Text>
                            </View>
                            <TouchableOpacity style={styles.iconstyle}>
